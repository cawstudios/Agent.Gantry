...
- Postgres is the only runtime store. `MYCLAW_DATABASE_URL` must point at a Postgres database with pgvector, full-text search support, and pg-boss initialized.
