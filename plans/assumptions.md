...
|----|------|-------|------------|--------|----------|
| A-0001 | 2026-07-22 | PAY-1 | Baseline File Size Budget inventory was undercounted (5 of 19 rows; truncated read of checker output). Stage E added for the remaining rows; mcp-tool-proxy ratcheted until CAP-1. | open |  |
