...
const OPERATING_GUIDANCE_BLOCK = [
  ...
  '- Search and request semantic capabilities first for app or tool access. Use request_permission for one-off exact tool access or scoped Bash rules only when no reviewed semantic capability fits.',
  '- Browser is always the canonical whole browser capability.',
